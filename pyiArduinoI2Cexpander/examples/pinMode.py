...
print("Проверяем выводы. Нажмите ctrl+c для выхода")               #
while True:                                                        #
  d = gpio.digitalRead(3)                                          #   Читаем логический уровень со входа 3 в переменную «d» (значение LOW или HIGH).
  a = gpio.analogRead(4)                                           #   Читаем аналоговый уровень со входа 4 в переменную «a» (значение от 0 до 4095).
  ...
  gpio.servoWrite(2, gpio.mymap(a,0,4095,0,180))                   #   Поворачиваем сервопривод на угол пропорциональный значению переменной a.
  sleep(.1)                                                        #
                                                                   #
#  ПРИМЕЧАНИЕ:                                                     #
